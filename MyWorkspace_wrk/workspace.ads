<ADSWorkspace Revision="1" Version="100">
    <Workspace Name="">
        ...
        <Cell Name="MyLibrary_lib:filter" />
        <Substrate Name="MyLibrary_lib:subtrato.subst" />
        <Dataset Name="filter_FEM.ds" />
        <Dataset Name="filter_FEM_c.ds" />
        <Data_Files Name="filter_FEM.ds" />
        <Data_Files Name="filter_FEM_c.ds" />
        <ConfigFile Name="dds.cfg" />
        <Data_Display Name="filter_FEM_c.dds" />
        <Dataset Name="filter_FEM_a.ds" />
        <Data_Files Name="filter_FEM_a.ds" />
