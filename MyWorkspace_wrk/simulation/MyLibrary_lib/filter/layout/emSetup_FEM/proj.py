...
class projImporter():
	...
	def create_materials(self,materialForEachLayer=False):
		...
		extraMaterialProperties=(140,3.5e-05,None,True) # (priority,thickness,modelTypeForMetals,convertedToResistance)
		material=ADSmaterialMap.get((ADSmaterialName,extraMaterialProperties),None)
		if material == None:
			EMProMaterialName = self._getEMProMaterialName(ADSmaterialName,ADSmaterialMap,extraMaterialProperties,ADSmaterialsNo1to1)
		...
		ADSmaterialName=["Proyecto","__SubstrateLayer1"][materialForEachLayer]
		extraMaterialProperties=(50,None,None,False) # (priority,thickness,modelTypeForMetals,convertedToResistance)
		material=ADSmaterialMap.get((ADSmaterialName,extraMaterialProperties),None)
		if material == None:
			EMProMaterialName = self._getEMProMaterialName(ADSmaterialName,ADSmaterialMap,extraMaterialProperties,ADSmaterialsNo1to1)
			material=self.session.create_material(name=EMProMaterialName, color=(202,225,255,128), permittivity=4.6, losstangent=0.0023, permeability=1, use_djordjevic=True, lowfreq=1000, evalfreq=1000000000, highfreq=1000000000000)
			try:
	...
	def create_geometry(self,topAssembly):
		...
		assembly=empro.geometry.Assembly()
		part=empro.geometry.Model()
		simBox = empro.geometry.Box( _createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox-xLowerBoundingBox", "abs((-0.0105-xLowerExtension)-(0.018584+xUpperExtension))"), _createIfToggleExtensionToBoundingBoxExpression("zUpperBoundingBox-zLowerBoundingBox", "((((stack_subtrato_layer_3_Z) + (zUpperExtension)) - (stack_subtrato_layer_1_Z)))"), _createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox-yLowerBoundingBox" , " abs((-0.01145-yLowerExtension)-(0.01325+yUpperExtension))"))
		part.recipe.append(simBox)
		part.coordinateSystem.anchorPoint = empro.geometry.CoordinateSystemPositionExpression(V(_createIfToggleExtensionToBoundingBoxExpression("(xUpperBoundingBox+xLowerBoundingBox)/2", "(0.018584+xUpperExtension+-0.0105-xLowerExtension)/2"), _createIfToggleExtensionToBoundingBoxExpression("(yUpperBoundingBox+yLowerBoundingBox)/2", "(0.01325+yUpperExtension+-0.01145-yLowerExtension)/2"), _createIfToggleExtensionToBoundingBoxExpression("zLowerBoundingBox","((stack_subtrato_layer_1_Z) - (0))")))
		...
		self.session.adjust_view()
		assembly=empro.geometry.Assembly()
		pointString='0.018584+xUpperExtension#-0.01145-yLowerExtension;0.018584+xUpperExtension#0.01325+yUpperExtension;-0.0105-xLowerExtension#0.01325+yUpperExtension;-0.0105-xLowerExtension#-0.01145-yLowerExtension'
		sketch = self._create_sketch(pointString)
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex0",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0105-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","-0.01145-yLowerExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex1",V(_createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox","0.018584+xUpperExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","-0.01145-yLowerExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex2",V(_createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox","0.018584+xUpperExtension"),_createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox","0.01325+yUpperExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex3",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0105-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox","0.01325+yUpperExtension"),0)))
		part=empro.geometry.Model()
		part.recipe.append(empro.geometry.Extrude(sketch,"(stack_subtrato_layer_3_Z) - (stack_subtrato_layer_1_Z)",V(0,0,1)))
		part.coordinateSystem.anchorPoint = empro.geometry.CoordinateSystemPositionExpression(V(0,0,"(stack_subtrato_layer_1_Z) - (0)"))
		...
		topAssembly.append(assembly)
		assembly=empro.geometry.Assembly()
		pointStrings=['-0.00432#-0.01145;-0.00432#0.00057;0.005825#0.00057;0.005825#-0.01145;0.009882#-0.01145;0.009882#0.00057;0.014084#0.00057;0.014084#-0.00055;0.018584#-0.00055;0.018584#0.00235;0.014084#0.00235;0.014084#0.00123;0.009882#0.00123;0.009882#0.01325;0.005825#0.01325;0.005825#0.00123;-0.00432#0.00123;-0.00432#0.01325;-0.006#0.01325;-0.006#0.00235;-0.0105#0.00235;-0.0105#-0.00055;-0.006#-0.00055;-0.006#-0.01145']
		...
		topAssembly.append(assembly)
		assembly=empro.geometry.Assembly()
		pointStrings=['0.021709#-0.014575;0.021709#0.016375;-0.013625#0.016375;-0.013625#-0.014575']
		sketch = None
		for pointString in pointStrings:
			sketch = self._create_sketch(pointString, sketch)
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex0",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0105-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","-0.01145-yLowerExtension"),0)))
		...
		try:
			...
			if mtrl.details.materialType() == "Physical": 
				...
				if eProp.propertyType() == "PEC" or eProp.parameters.parametersType() == "PEC":
					...
					if (float(empro.core.Expression("((stack_subtrato_layer_1_Z) - (0))")) <= bbox_3dcs.lower.z + SPAresabs ) :
	...
	def create_ports( self, topAssembly, includeInvalidPorts=True, symbPinData=None):
		...
		head=V("(-0.0105) - (0)","(0.0009) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		tail=V("(-0.0105) - (0)","(0.0009) - (0)","(stack_subtrato_layer_1_Z) - (0)")
		extent=empro.components.SheetExtent()
		extent.endPoint1Position=V("(-0.0105) - (0)","(-0.00055) - (0)","(stack_subtrato_layer_1_Z) - (0)")
		extent.endPoint2Position=V("(-0.0105) - (0)","(0.00235) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		...
		head=V("(0.018584) - (0)","(0.0009) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
		tail=V("(0.018584) - (0)","(0.0009) - (0)","(stack_subtrato_layer_1_Z) - (0)")
		extent=empro.components.SheetExtent()
		extent.endPoint1Position=V("(0.018584) - (0)","(-0.00055) - (0)","(stack_subtrato_layer_1_Z) - (0)")
		extent.endPoint2Position=V("(0.018584) - (0)","(0.00235) - (0)","(((mask_cond_Zmax) + (mask_cond_Zmin)) / (2)) - (0)")
	...
	def create_parameters(self):
		self._create_parameter("stack_subtrato_layer_1_Z", "0 mm", "Z of topology level (level 1 of stack subtrato)",True,fixGridAxis='Z')
		self._create_parameter("stack_subtrato_layer_3_Z", "1.6 mm", "Z of topology level (level 3 of stack subtrato)",True,fixGridAxis='Z')
